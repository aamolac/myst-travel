      ...
      <div className="privacy-container">
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              en analysant les comportements sur le site.
            </li>
            <li>
        ...
        <section>
          ...
          <p>
            ...
            autorisé, divulgation, modification ou destruction. Toutefois,
        ...
        <section>
          ...
          <ul>
            <li>
              Droit d'accès : Vous pouvez demander une copie des données que
        ...
        <section>
          ...
          <p>
            ...
            obligations légales, ou pour résoudre des litiges. Lorsque vos
            données ne sont plus nécessaires, nous les supprimons de manière
            sécurisée.
          </p>
        </section>

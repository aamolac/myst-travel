    ...
    <main id="about-us">
      ...
      <section>
        <p>
          ...
          les meilleures expériences sont souvent celles que l’on n’attend pas.
      ...
      <section className="why-myst-travel">
        <div>
          ...
          <p>
            ...
            échappée unique. Nous concevons des aventures surprenantes qui vous
            plongent dans l’inconnu, vous permettent de vous évader et de vivre
        ...
        <div>
          ...
          <p>
            ...
            rend chaque expérience plus intense. En ne dévoilant pas la
            destination, nous réinjectons de la magie dans le voyage.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            permettent de lâcher prise, d'embrasser l'inconnu et de renouer avec
            l’aventure, loin de la routine quotidienne.
          </p>
        </div>
        <div>
      ...
      <section>
        ...
        <p>
          ...
          adaptées à vos préférences. Qu’il s’agisse d’un week-end en Europe ou
